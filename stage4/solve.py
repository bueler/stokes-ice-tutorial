...
parser.add_argument('-mx', type=int, metavar='MX', default=40,
    help='number of subintervals for the coarse mesh')
...
print('generating %d-level mesh hierarchy (coarse = %d x %d) by extrusion ...' \
      % (args.refine + 1, args.mx, args.mz))
R = 10000.0
H = 1000.0
