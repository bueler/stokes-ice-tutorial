...
% ./solve.py -s_snes_rtol 1.0e-5 -s_snes_converged_reason -mx MX -mz MZ
\begin{center}
\begin{tabular}{c|rrr}
...
\begin{itemize}
\item \texttt{stage3/} code \texttt{solve.py} is set-up for adjustable resolution:
\begin{Verbatim}
$ ./solve.py -mx 20 -mz 2
\end{Verbatim}
%$
\item results are at least reasonable and consistent
\end{itemize}
\end{frame}
...
% timer ./solve.py -s_snes_rtol 1.0e-5 -s_snes_converged_reason -mx MX -mz MZ
% N = MX MY (4*2 + 1)  is approximately correct for Q2xQ1
% SNES iterations: 44, 10, 13, 11, 13
\begin{center}
\begin{tabular}{c|rr|rr}
mesh           &   $N$ & ratio & run time (s) & ratio \\ \hline
$20\times 2$   &   360 &       &          2.0 &       \\
$40\times 4$   &  1440 &     4 &          2.1 &   1.1 \\
$80\times 8$   &  5760 &     4 &          4.8 &   2.2 \\
$160\times 16$ & 23040 &     4 &         29.6 &   6.2 \\
$320\times 32$ & 92160 &     4 &        495.0 &  16.7 \\
\end{tabular}
\end{center}

\begin{itemize}
\item \texttt{stage3/} performance is not scaling well
\item if number of degrees of freedom $N$ goes up by 4 then time should only go up by 4 also?
\end{itemize}
\end{frame}
