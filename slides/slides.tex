...
\begin{frame}[fragile]
\frametitle{activate the Firedrake virtual environment}
...
\item \emph{files:} \texttt{domain.geo}, \texttt{solve.py}
\end{itemize}
...
\item \emph{files:} \texttt{domain.py}, \texttt{solve.py}
\end{itemize}
...
\vspace{10mm}
\begin{center}
FIXME %\includegraphics[width=0.9\textwidth]{figs/stage1.png}
\end{center}
\end{frame}
